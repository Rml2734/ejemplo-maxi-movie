...
namespace maxi_movie_mvc.Data
{
    public class DbSeeder
    {
        public static async Task Seed(MovieDbContext context, UserManager<Usuario> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            // 3. Definir listas de catálogos base (Plataformas)
            ...
            // 3. Definir listas de catálogos base (Géneros)
            ...
            // 4. Agregamos catálogos a la base de datos y guardamos asíncronamente para generar IDs
            await context.Plataformas.AddRangeAsync(plataformas);
            await context.Generos.AddRangeAsync(generos);
            await context.SaveChangesAsync();

            // 5. Mapeo a diccionarios en memoria utilizando las entidades recién guardadas
            ...
            // 7. Guardado final de películas vinculadas
